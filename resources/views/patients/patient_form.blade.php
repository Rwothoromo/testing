...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                <label for="national_id"><?php // echo 'National ID Number'; ?></label>
                <div class="controls">
...
<!--        <div class="form-group">
            <label for="datebirth"><?php // echo 'Date of Birth'; ?></label>
            <div class="controls">
...
<!--        <div class="form-group">
        ...
        <!-- Group -->
<!--        <div class="form-group">
            <label for="village"><?php // echo 'Marital Status'; ?></label>
...
<!--        <div class="form-group">
    ...
    <div class="col-md-4">
        <!-- Group -->
<!--        <div class="form-group">
            <label for="village"><?php // echo 'Occupation'; ?></label>
            <div class="controls">
        ...
        <!-- Group -->
<!--        <div class="form-group">
            <label for="village"><?php // echo 'Next of Kin'; ?></label>
...
<!--        <div id="next_kin_div" style="DISPLAY: none">
        ...
        <!-- Group -->
<!--        <div class="form-group">
            <label for="village"><?php // echo 'Mobile Number'; ?></label>
        ...
        <!-- Group -->
<!--        <div class="form-group">
            <label for="village"><?php // echo 'Mobile Owner'; ?></label>
            <div class="controls">
